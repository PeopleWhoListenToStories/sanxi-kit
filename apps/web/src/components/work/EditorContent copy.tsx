...
export const EditorContent = ({ documentId }: IProps) => {
  ...
  return (
    <>
      ...
      <BlockEditor editable={true} shareDocId={documentId} aiToken={aiToken} hasCollab={hasCollab} ydoc={ydoc} provider={provider} />
    </>
  )
}