...
const Editor = React.memo(({ userName, aiToken, ydoc, hasCollab, provider, docId, editable = true }: { userName: string, aiToken?: string; ydoc: Y.Doc | null; docId: string, hasCollab: boolean, editable: boolean, provider?: HocuspocusProvider | null | undefined }) => {
  ...
  return (
    <main className='px-[20px] overflow-y-scroll'>
      <div className='maxWidth-[1024px]'
        style={{
          maxWidth: 1024,
