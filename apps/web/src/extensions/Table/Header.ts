import { Decoration, DecorationSet, PMPlugin } from '@sanxi-kit/core';
import { TableHeader as SanxiKitTableHeader } from '@sanxi-kit/table';

import { getCellsInRow, isColumnSelected, selectColumn } from './utils';

export const TableHeader = SanxiKitTableHeader.extend({
  addAttributes() {
    return {
      colspan: {
        default: 1,
